...
export class StudentManagementService {
  ...
  static async getStudents(filters?: StudentFilters): Promise<Student[]> {
    ...
    try {
      ...
      if (filters?.crtEligibility && filters.crtEligibility !== "ALL") {
        params.append(
          "crtEligibility",
          filters.crtEligibility === "ELIGIBLE" ? "true" : "false"
        );
      }
      ...
      console.error(
        "[StudentManagementService] Error fetching students:",
        error
      );
      throw error;
    }
  ...
  static async getStudentById(id: string): Promise<Student> {
    ...
    try {
      ...
      console.error(
        "[StudentManagementService] Error fetching student:",
        error
      );
      throw error;
    }
  ...
  static async getStudentByEmail(email: string): Promise<Student> {
    ...
    try {
      ...
      console.error(
        "[StudentManagementService] Error fetching student by email:",
        error
      );
      throw error;
    }
  ...
  static async getStudentByRegNum(regNum: string): Promise<Student> {
    ...
    try {
      ...
      console.error(
        "[StudentManagementService] Error fetching student by regNum:",
        error
      );
      throw error;
    }
  ...
  static async createStudent(
    ...
    try {
      ...
      console.error(
        "[StudentManagementService] Error creating student:",
        error
      );
      throw error;
    }
  ...
  static async updateStudent(
    ...
    try {
      ...
      console.error(
        "[StudentManagementService] Error updating student:",
        error
      );
      throw error;
    }
  ...
  static async removeFromCRT(id: string, reason: string): Promise<void> {
    ...
    try {
      ...
      console.error(
        "[StudentManagementService] Error removing student from CRT:",
        error
      );
      throw error;
    }
  ...
  static async addToCRT(id: string, reason: string): Promise<void> {
    ...
    try {
      ...
      console.error(
        "[StudentManagementService] Error adding student to CRT:",
        error
      );
      throw error;
    }
  ...
  private static async getMockStudents(
