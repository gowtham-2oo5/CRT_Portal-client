...
export function OtpDialog({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success && result.data) {
        ...
        // Check if we have a callback for OTP success
        if (onOtpSuccess && currentUser) {
          console.log("[OTP] Calling onOtpSuccess callback");
          onOtpSuccess(currentUser);
        } else {
          console.log("[OTP] No callback, showing dashboard loader");
  ...
  return (
    <>
      ...
      {/* Dashboard Loader - only show if no callback provided */}
      {!onOtpSuccess && (
        <DashboardLoader
