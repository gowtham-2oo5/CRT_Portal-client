        ...
        <div className="relative z-10 flex flex-col justify-center items-center p-12 text-white">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-lg opacity-90 max-w-md leading-relaxed">
              Streamlining career readiness training coordination with automated scheduling, real-time attendance tracking, and comprehensive analytics for students, faculty, and administrators at KL University.
            </p>
          </div>
        </div>
      </div>
