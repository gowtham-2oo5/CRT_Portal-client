                    ...
                    <Card>
                        <CardContent className="p-4">
                            <div className="flex items-center space-x-2">
                                ...
                                <div>
                                    <div
                                        className="text-2xl font-bold text-green-600">{sectionStats.averageAttendance}%
                                    </div>
                    ...
                    <Card>
                        <CardContent className="p-4">
                            <div className="flex items-center space-x-2">
                                ...
                                <div>
                                    <div
                                        className="text-2xl font-bold text-green-600">{sectionStats.goodAttendance}</div>
                    ...
                    <div className="space-y-4">
                        ...
                        {filteredReports.length === 0 && (
                            <div className="text-center py-8">
                                ...
                                <p className="text-muted-foreground">No students found matching the selected
                                    filters.</p>
                            </div>
                        )}
                    </div>
                ...
                <Card className="border-blue-200 bg-blue-50 dark:border-blue-800 dark:bg-blue-950/20">
                    ...
                    <CardContent>
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center space-x-4">
                                <div
                                    className={`px-4 py-2 rounded-lg ${getAttendanceColor(selectedStudent.attendancePercentage)}`}>
                                    <div className="flex items-center space-x-2">
